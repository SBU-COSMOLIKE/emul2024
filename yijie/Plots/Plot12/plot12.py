...
ax1.plot(n_train,pertail128,'b-',label='TRF, T=128, fraction of tail')

ax1.plot(n_train,pertail64,'r-',label='TRF, T=64, fraction of tail')

ax1.plot(n_train,pertail128res,'g-',label='ResMLP, T=128, fraction of tail')

ax1.plot(n_train,pertail64res,'p-',label='ResMLP, T=64, fraction of tail')
ax2 = ax1.twinx()
...
ax2.plot(n_train,med64res,'p--',label=r'ResMLP, T=64, median $\chi^2$')
