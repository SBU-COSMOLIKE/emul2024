...
samples1 = MCSamples(samples=d1,names = names, labels = labels,label='Uniform Train'
                     ,ranges={'omegabh2':(0,0.042),'omegach2':(0,0.3),'H0':(20, 120),'tau':(0.005, 0.16)
...
plt.plot([0,0],[0,0],color='dimgray',label='Uniform Train')
plt.hist([0,0],color='firebrick',label='Uniform Test')
plt.hist([0,0],color='lightseagreen',label=r'Planck 2018')
plt.legend(loc=[-2.53,0.82],fontsize=13,frameon=False,ncol=2)

g.fig.savefig('plot23full.pdf',format="pdf", bbox_inches="tight", dpi=300, pad_inches=0.05)
