...
plt.legend()
plt.savefig("gutcmbres.pdf", format="pdf", bbox_inches="tight")
...
#plt.legend()
plt.savefig("gutcmbreserror.pdf", format="pdf", bbox_inches="tight")
...
#plt.axhline(y = 0, color = 'grey', linestyle = '-') 
plt.savefig("gutcmbreschi.pdf", format="pdf", bbox_inches="tight")