...
plt.legend()
plt.savefig("gutresas.pdf", format="pdf", bbox_inches="tight")
...
#plt.legend()
plt.savefig("gutresaserror.pdf", format="pdf", bbox_inches="tight")
...
#plt.axhline(y = 0, color = 'grey', linestyle = '-') 
plt.savefig("gutresaschi.pdf", format="pdf", bbox_inches="tight")