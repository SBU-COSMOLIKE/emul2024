...
plt.legend()
plt.savefig("fullcmbastau.pdf", format="pdf", bbox_inches="tight")
...
#plt.legend()
plt.savefig("fullcmbastauerror.pdf", format="pdf", bbox_inches="tight")
...
#plt.axhline(y = 0, color = 'grey', linestyle = '-') 
plt.savefig("fullcmbastauchi.pdf", format="pdf", bbox_inches="tight")