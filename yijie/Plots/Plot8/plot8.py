...
plt.legend()
plt.savefig("mlpwd.pdf", format="pdf", bbox_inches="tight")
...
#plt.legend()
plt.savefig("mlpwderror.pdf", format="pdf", bbox_inches="tight")
...
#plt.axhline(y = 0, color = 'grey', linestyle = '-') 
plt.savefig("mlpwdchi.pdf", format="pdf", bbox_inches="tight")